...
var _contentUtils = require('./content-utils');

var contentUtils = _interopRequireWildcard(_contentUtils);

var _service_channel = require('./service_channel');

var _service_channel2 = _interopRequireDefault(_service_channel);
...
var PipelineContext = (function () {
    ...
    PipelineContext.prototype._dispatch = function _dispatch() {
        if (_service_channel2.default.shouldProcess(this.req.url)) {
    ...
    PipelineContext.prototype.buildContentInfo = function buildContentInfo() {
        ...
        if (contentType) isPage = isPage && contentUtils.isPageMIME(contentType);
