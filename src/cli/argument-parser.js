...
export default class CLIArgumentParser {
    ...
    _describeProgram () {
        ...
        this.program
            ...
            .option('--ts-config-path <path>', 'specifies the TypeScript configuration file location. If the tsConfigPath option is not specified, TestCafe looks for the tsconfig.json file in the current directory.')
