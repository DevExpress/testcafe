export default {
    ...
    regeneratorInClientFunctionCode:     '{#instantiationCallsiteName} code, arguments or envirioment variables cannot contain generators or `async/await` syntax (use Promises instead).',
    clientFunctionEnvIsNotAnObject:      `{#instantiationCallsiteName} "env" argument is expected to be an object, but it was "{type}".`,
