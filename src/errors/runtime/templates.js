...
export default {
    ...
    [RUNTIME_ERRORS.dashboardTokenInJSON]:                "The dashboard's token cannot be used in the JSON configuration file due to security reasons. Please specify it using programmatic, command-line, environment variables or use .js configuration file instead.",
};
