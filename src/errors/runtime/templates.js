...
export default {
    ...
    [RUNTIME_ERRORS.invalidSkipJsErrorsOptionsObjectKey]:       `The "{optionName}" option does not exist. Use the following options to configure skipJsErrors: ${getConcatenatedValuesString(Object.keys(SKIP_JS_ERRORS_OPTIONS_OBJECT_OPTION_NAMES))}.`,
    [RUNTIME_ERRORS.invalidSkipJsErrorsCallbackWithOptionsKey]: `The "{optionName}" option does not exist. Use the following options to configure skipJsErrors callback: ${getConcatenatedValuesString(Object.keys(SKIP_JS_ERRORS_CALLBACK_WITH_OPTIONS_OPTION_NAMES))}.`,
};
