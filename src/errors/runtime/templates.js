...
export default {
    ...
    [RUNTIME_ERRORS.invalidQuarantineOption]:                            'The "{optionName}" option should be one of "attemptLimit" or "successThreshold" if you specify custom quarantine mode settings.',
    [RUNTIME_ERRORS.invalidQuarantineParametersRatio]:                   'The "attemptLimit" ({attemptLimit}) value should be greater then "successThreshold" ({successThreshold}).',
    [RUNTIME_ERRORS.invalidAttemptLimitValue]:                           'The "{attemptLimit}" cannot be less than {MIN_ATTEMPT_LIMIT}.',
    [RUNTIME_ERRORS.invalidSuccessThresholdValue]:                       'The "{successThreshold}" cannot be less than {MIN_SUCCESS_THRESHOLD}.',
    ...
    [RUNTIME_ERRORS.cannotSetConcurrencyWithCDPPort]:                    'The concurrency factor should be used without CDP port.',
