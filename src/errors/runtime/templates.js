...
export default {
    ...
    [RUNTIME_ERRORS.requestUrlError]:                     'Requested url isn\'t valid ({actualValue}).',
    [RUNTIME_ERRORS.requestMethodError]:                  'Request support only methods: GET, POST, PUT, PATCH, DELETE, HEAD. Actual method: ({actualValue}).',
};
