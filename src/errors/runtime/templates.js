...
export default {
    ...
    [RUNTIME_ERRORS.clientFunctionCodeIsNotAFunction]:                   'Cannot execute a clientFunction becuase {#instantiationCallsiteName} is {type}, and not a function.',
    ...
    [RUNTIME_ERRORS.invalidClientFunctionTestRunBinding]:                'Cannot resolve the "boundTestRun" option becuase its value is not a test controller.',
    [RUNTIME_ERRORS.invalidValueType]:                                   'Expected {smthg} to be {type}, but it was {actual}.',
    ...
    [RUNTIME_ERRORS.clientScriptInitializerMultipleContentSources]:    'Client scripts can only have one initializer: a JavaScript script, a JavaScript file path, or the name of a JavaScript module.',
