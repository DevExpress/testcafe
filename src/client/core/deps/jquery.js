...
// Define a local copy of jQuery
        var jQuery = exportedJQuery = function (selector, context) {
        ...
        jQuery(function () {
            ...
            if (window.getComputedStyle) {
                ...
                support.reliableMarginRight =
                    ( parseInt(( window.getComputedStyle(marginDiv, null) || { marginRight: 0 } ).marginRight, 10) ||
                      0 ) === 0;
            }
