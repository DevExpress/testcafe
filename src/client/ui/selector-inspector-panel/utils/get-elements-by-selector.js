...
async function parseSelector (selector) {
    const { parseSelectorUrl } = window[INTERNAL_PROPERTIES.testCafeDriverInstance].communicationUrls;

    return browser.parseSelector(parseSelectorUrl, createNativeXHR, selector);
}
