...
export function init (window, undefined) {
    ...
    /*!
         ...
         */
    var jQueryFunction = function (window, undefined) {
        ...
        var jQuery    = (function () {
            ...
            jQuery.extend({
                ...
                ready: function (wait) {
                    ...
                    if ((wait === true && !--jQuery.readyWait) || (wait !== true && !jQuery.isReady)) {
                        ...
                        if (!document.body) {
                            return nativeMethods.setTimeout.call(window, jQuery.ready, 1);
                        }
            ...
            function doScrollCheck () {
                ...
                try {
                    ...
                    nativeMethods.setTimeout.call(window, doScrollCheck, 1);
                    return;
                }
        ...
        boolHook = {
            get: function (elem, name) {
                ...
                return property === true ||
                       typeof property !== "boolean" && ( attrNode = elem.getAttributeNode(name) ) &&
     ...
     */
                ...
                function doAnimation () {
                    ...
                    for (name in prop) {
                        ...
                        if (jQuery.isArray(val)) {
                            ...
                            opt.animatedProperties[name] = opt.specialEasing && opt.specialEasing[name] || opt.easing ||
                                                           'swing';
                        }
        ...
        function createFxNow () {
            nativeMethods.setTimeout.call(window, clearFxNow, 0);
        ...
        jQuery.fx.prototype = {
            ...
            hide: function () {
                // Remember where we started, so that we can go back to it later
                this.options.orig[this.prop] = jQuery._data(this.elem, "fxshow" + this.prop) ||
