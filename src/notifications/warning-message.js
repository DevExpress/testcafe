export default {
    ...
    retryTestPagesIsNotSupported:       'The \'retryTestPages\' option was not enabled in the "{browserAlias}" browser. Please ensure your browser supports Service Worker API (https://developer.mozilla.org/en-US/docs/Web/API/Service_Worker_API)\n'
};
