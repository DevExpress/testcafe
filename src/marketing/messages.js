...
const YOUR_CAN_STOP_WRITING    = `You can stop writing and start recording. Check out our commercial testing platform – now with a fully integrated visual test recorder: ${DOMAIN_1}`;
