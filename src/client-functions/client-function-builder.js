...
export default class ClientFunctionBuilder {
    ...
    _createInvalidFnTypeError () {
        return new ClientFunctionAPIError(this.callsiteNames.instantiation, this.callsiteNames.instantiation, RuntimeErrors.clientFunctionCodeIsNotAFunction, typeof this.fn);
    }
    ...
    _executeCommand (args, testRun, callsite) {
        ...
        return ReExecutablePromise.fromFn(async () => {
            if (!testRun) {
                const err = new ClientFunctionAPIError(this.callsiteNames.execution, this.callsiteNames.instantiation, RuntimeErrors.clientFunctionCantResolveTestRun);
    ...
    _validateOptions (options) {
        ...
        if (!isNullOrUndefined(options.boundTestRun)) {
            ...
            if (!boundTestRun[testRunMarker])
                throw new APIError(this.callsiteNames.instantiation, RuntimeErrors.invalidClientFunctionTestRunBinding);
        }
