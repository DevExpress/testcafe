...
export default class SelectorBuilder extends ClientFunctionBuilder {
    ...
    _createInvalidFnTypeError () {
        return new ClientFunctionAPIError(this.callsiteNames.instantiation, this.callsiteNames.instantiation, RuntimeErrors.selectorInitializedWithWrongType, typeof this.fn);
    }
