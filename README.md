...
### Write Test Code in TypeScript and Modern JavaScript

You can write TestCafe tests using both TypeScript and JavaScript with the latest features like `async/await`.
