...
HammerheadClient.define('UrlUtil', function (require) {
    ...
    UrlUtil.sameOriginCheck = function (location, checkedUrl) {
        return SharedUrlUtil.sameOriginCheck(location, checkedUrl, UrlUtil.resolveUrl);
    };
    ...
    UrlUtil.isIframeWithoutSrc = function (iframe) {
        ...
        if (!iFrameDocumentLocationHaveSupportedProtocol &&
            !(iframe.attributes['src'] && iframe.attributes['src'].value))
            return true;
    ...
    UrlUtil.getIframeLocation = function (iframe) {
        ...
        var srcLocation                 = NativeMethods.getAttribute.call(iframe, 'src' +
            ...
            parsedProxyDocumentLocation = documentLocation && UrlUtil.isSupportedProtocol(documentLocation) &&
                                          UrlUtil.parseProxyUrl(documentLocation),
            parsedProxySrcLocation      = srcLocation && UrlUtil.isSupportedProtocol(srcLocation) &&
                                          UrlUtil.parseProxyUrl(srcLocation);
    ...
    UrlUtil.OriginLocation = {
        get: function () {
            ...
            return UrlUtil.parseProxyUrl(location).originUrl;
        },
        ...
        getCookiePathPrefix: function () {
            var parsedLocation = UrlUtil.parseProxyUrl(getLocation());
