(function () {
    ...
    UrlUtil.sameOriginCheck = function (location, checkedUrl, resolveUrl) {
        if (!checkedUrl)
            return true;
        ...
        var parsedLocation      = UrlUtil.parseUrl(location),
            parsedCheckedUrl    = UrlUtil.parseUrl(checkedUrl, parsedLocation.protocol),
            parsedProxyLocation = UrlUtil.parseProxyUrl(location, UrlUtil.parseUrl),
