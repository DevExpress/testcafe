    ...
    describe('Validation', function () {
        it('Should validate СlickСommand', function () {
            assertThrow(
                ...
                },
                {
                    ...
                    type:            TestRunErrors.actionSelectorError.name,
                    code:            'E23',
            ...
            assertThrow(
                ...
                {
                    isTestCafeError: true,
                    type:            TestRunErrors.actionOptionsTypeError.name,
                    code:            'E14',
                    actualType:      'number',
                    callsite:        null
                }
            ...
            assertThrow(
                ...
                {
                    isTestCafeError: true,
                    type:            TestRunErrors.actionIntegerOptionError.name,
                    code:            'E9',
                    optionName:      'offsetX',
                    actualValue:     'string',
                    callsite:        null
        ...
        it('Should validate RightСlickСommand', function () {
            ...
            assertThrow(
                ...
                {
                    isTestCafeError: true,
                    type:            TestRunErrors.actionBooleanOptionError.name,
                    code:            'E11',
        ...
        it('Should validate DoubleСlickСommand', function () {
            ...
            assertThrow(
                ...
                {
                    isTestCafeError: true,
                    type:            TestRunErrors.actionPositiveIntegerOptionError.name,
                    code:            'E10',
                    optionName:      'caretPos',
                    actualValue:     'string',
                    callsite:        null
        ...
        it('Should validate DragСommand', function () {
            ...
            assertThrow(
                ...
                {
                    isTestCafeError: true,
                    type:            TestRunErrors.actionIntegerArgumentError.name,
                    code:            'E20',
        ...
        it('Should validate TypeTextСommand', function () {
            ...
            assertThrow(
                ...
                {
                    isTestCafeError: true,
                    type:            TestRunErrors.actionStringArgumentError.name,
                    code:            'E16',
                    argumentName:    'text',
                    actualValue:     'undefined',
                    callsite:        null
        ...
        it('Should validate SelectTextСommand', function () {
            ...
            assertThrow(
                ...
                {
                    isTestCafeError: true,
                    type:            TestRunErrors.actionPositiveIntegerArgumentError.name,
                    code:            'E22',
        ...
        it('Should validate SetFilesToUploadCommand', function () {
            ...
            assertThrow(
                ...
                {
                    isTestCafeError: true,
                    type:            TestRunErrors.actionStringOrStringArrayArgumentError.name,
                    code:            'E18',
            ...
            assertThrow(
                ...
                {
                    isTestCafeError: true,
                    type:            TestRunErrors.actionStringArrayElementError.name,
                    code:            'E19',
                    argumentName:    'filePath',
                    actualValue:     'number',
                    elementIndex:    1,
        ...
        it('Should validate ResizeWindowToFitDeviceСommand', function () {
            ...
            assertThrow(
                ...
                {
                    isTestCafeError: true,
                    type:            TestRunErrors.actionUnsupportedDeviceTypeError.name,
                    code:            'E38',
                    argumentName:    'device',
        ...
        it('Should validate SetTestSpeedCommand', function () {
            assertThrow(
                ...
                {
                    isTestCafeError: true,
                    type:            TestRunErrors.setTestSpeedArgumentError.name,
                    code:            'E47',
                    argumentName:    'speed',
                    actualValue:     'undefined',
                    callsite:        null
        ...
        it('Should validate ExecuteExpressionСommand', function () {
            ...
            assertThrow(
                ...
                {
                    isTestCafeError: true,
                    type:            TestRunErrors.actionBooleanArgumentError.name,
                    code:            'E15',
                    actualValue:     'number',
