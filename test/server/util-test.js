        ...
        const testCases = [
            ...
            },
            {
                ...
                expected: {
                    ...
                    engine:        { name: 'Blink' },
                    userAgent:     'Chrome 78.0.3904.70 / Windows 10',
                    fullUserAgent: 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36'
                }
            },
            {
                ...
                expected: {
                    ...
                    userAgent:     'Safari 12.1 / iOS 12.2',
                    fullUserAgent: 'Mozilla/5.0 (iPad; CPU OS 12_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/12.1 Mobile/15E148 Safari/604.1'
                }
            },
            {
                ...
                expected: {
                    ...
                    engine:        { name: 'Blink' },
                    userAgent:     'Chrome 67.0.3396.87 / Android 8.1.0',
                    fullUserAgent: 'Mozilla/5.0 (Linux; Android 8.1.0; Android SDK built for x86 Build/OSM1.180201.026) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.87 Mobile Safari/537.36'
                }
            }
        ];
