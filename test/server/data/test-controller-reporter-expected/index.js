...
module.exports = [
    {
        ...
        command: {
            ...
            selector: { query: 'Selector(\'#target\')' },
            type:     'click'
        },
        test:    {
            id:    'test-id',
    ...
    },
    {
        ...
        command: {
            ...
            selector: { query: 'Selector(\'#target\')' },
            destinationSelector: { query: 'Selector(\'#target\')' },
    ...
    },
    {
        ...
        command: {
            options:   basicOptions,
            selector: { query: 'Selector(\'#textarea\')' },
            startLine: 1,
            startPos:  2,
            endLine:   3,
            endPos:    4,
    ...
    },
    {
        ...
        command: {
            options:       basicOptions,
            startSelector: { query:'Selector(\'#contenteditable\')' },
            endSelector:   { query:  'Selector(\'#contenteditable\')' },
    ...
    },
    {
        ...
        name:    'switchToIframe',
        command: {
            selector: { query:'Selector(\'#iframe\')' },
