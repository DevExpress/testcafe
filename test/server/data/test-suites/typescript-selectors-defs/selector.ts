...
(async () => {
    ...
    expect(sel.hasAttribute('data-something')).not.ok;
    expect(sel.hasAttribute('data-something-else')).not.ok;

    expect(el.hasAttribute('id')).ok;
    expect(el.hasAttribute('class')).ok;
    expect(el.hasAttribute('style')).ok;
    expect(el.hasAttribute('data-something')).not.ok;
    expect(el.hasAttribute('data-something-else')).not.ok;
