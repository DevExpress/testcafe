...
describe('CLI argument parser', function () {
    ...
    it('Should parse command line arguments', function () {
        return parse('-r list -S -q -e --hostname myhost --proxy localhost:1234 --proxy-bypass localhost:5678 --qr-code --app run-app --speed 0.5 --debug-on-fail --no-page-reload ie test/server/data/file-list/file-1.js')
            .then(function (parser) {
                ...
                expect(parser.opts.noPageReload).to.be.ok;
