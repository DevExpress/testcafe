describe('[Regression](GH-2067) - Radio button navigation by keyboard', function () {
    ...
    it('nonamed - chrome', function () {
        return runTests('testcafe-fixtures/index.js', 'nonamed - chrome', { only: ['edge-chromium', 'chrome-osx'] });
    });

    it('nonamed - ie, firefox', function () {
        return runTests('testcafe-fixtures/index.js', 'nonamed - ie, firefox', { skip: ['edge-chromium', 'chrome-osx', 'android'] });
    });
