...
describe('Custom client scripts', () => {
    ...
    describe('Should handle errors of the injected scripts', () => {
        ...
        it('Script loaded from file', () => {
            return runTests('./testcafe-fixtures/error-in-script-from-file.js', null, { shouldFail: true, only: 'edge-chromium' })
                .catch(errs => {
        ...
        it('Script loaded from module', () => {
            return runTests('./testcafe-fixtures/error-in-script-from-module.js', null, { shouldFail: true, only: 'edge-chromium' })
                .catch(errs => {
