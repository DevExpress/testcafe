...
describe('[API] Wait', function () {
    describe('t.wait', function () {
        it('Should wait for the specified time', function () {
            return runTests('./testcafe-fixtures/wait-test.js', 'Wait', { only: 'edge-chromium' });
        });

        it('Should validate the timeout argument', function () {
            return runTests('./testcafe-fixtures/wait-test.js', 'Incorrect timeout argument (wait)', { only: 'edge-chromium' })
                .catch(function (errs) {
