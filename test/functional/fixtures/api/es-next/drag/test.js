...
describe('[API] Drag actions', function () {
    describe('t.drag', function () {
        it('Should drag an element by an offset', function () {
            return runTests('./testcafe-fixtures/drag-test.js', 'Drag to offset', { shouldFail: true, only: 'chrome', skip: 'chrome-osx' })
                .catch(function (errs) {
    ...
    describe('t.dragToElement', function () {
        it('Should drag an element to another element', function () {
            return runTests('./testcafe-fixtures/drag-test.js', 'Drag to element', { shouldFail: true, only: 'chrome', skip: 'chrome-osx' })
                .catch(function (errs) {
    ...
    describe('html5 drag and drop', function () {
        ...
        it('Should reproduce native browser behavior', function () {
            return runTests('./testcafe-fixtures/drag-and-drop-test.js', 'drag link and image', { only: 'chrome', skip: 'chrome-osx' });
        });
