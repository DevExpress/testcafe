...
describe('[API] Select text', function () {
    describe('t.selectText', function () {
        it('Should select text in input', function () {
            return runTests('./testcafe-fixtures/select-text-test.js', 'Select text in input', { only: 'chrome', skip: 'chrome-osx' });
        });
    ...
    describe('t.selectTextAreaContent', function () {
        it('Should select content in textarea', function () {
            return runTests('./testcafe-fixtures/select-text-test.js', 'Select content in textarea', { only: 'chrome', skip: 'chrome-osx' });
        });
    ...
    describe('t.selectEditableContent', function () {
        it('Should select editable content', function () {
            return runTests('./testcafe-fixtures/select-text-test.js', 'Select editable content', { only: 'chrome', skip: 'chrome-osx' });
        });
