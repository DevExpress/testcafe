...
describe('[API] TestController', () => {
    it('Should support chaining', () => {
        return runTests('./testcafe-fixtures/test-controller-test.js', 'Chaining', { shouldFail: true, only: 'edge-chromium' })
            .catch(errs => {
    ...
    describe('Missing `await` tracking', () => {
        ...
        describe('Regression', () => {
            it('Should allow chains within chain (GH-1285)', () => {
                return runTests('./testcafe-fixtures/test-controller-test.js', 'GH-1285', { only: 'edge-chromium' });
            });
        });
    });
});
