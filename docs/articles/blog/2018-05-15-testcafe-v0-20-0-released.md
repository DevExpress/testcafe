...
See [Intercepting HTTP Requests](https://devexpress.github.io/testcafe/documentation/guides/advanced-guides/intercept-http-requests.html) for more information.
...
To specify resources that require direct access, use the [--proxy-bypass](https://devexpress.github.io/testcafe/documentation/reference/command-line-interface.html#--proxy-bypass-rules) flag in the command line or the [useProxy](https://devexpress.github.io/testcafe/documentation/reference/testcafe-api/runner/useproxy.html) API method's parameters.
...
You can define metadata for a fixture or a test using the [meta](https://devexpress.github.io/testcafe/documentation/guides/basic-guides/organize-tests.html#specify-test-metadata) method:
...
To include testing metadata to reports, use the [custom reporter methods](https://devexpress.github.io/testcafe/documentation/reference/plugin-api/reporter.html).
...
If you need to assert a regular promise, set the [allowUnawaitedPromise](https://devexpress.github.io/testcafe/documentation/guides/basic-guides/assert.html#optionsallowunawaitedpromise) option to `true`.
