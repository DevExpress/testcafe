...
> Important! The `RequestHook._onConfigureResponse()` method is not part of TestCafe public API. As a private method, it can be removed or deprecated in the upcoming releases without prior warning. Be cautious when you override this method in your request hooks.
