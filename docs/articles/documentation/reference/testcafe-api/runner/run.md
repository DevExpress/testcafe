...
`stopOnFirstFail`    | Boolean | Defines whether or not to stop a test run if a test fails. You do not need to wait for all the tests to finish to focus on the first error. | `false`
