...
`pageRequestTimeout` | Number | Time (in milliseconds) to wait for a server to serve an HTML page. If the page isn't served within the specified period, an error is thrown. | `25000`
