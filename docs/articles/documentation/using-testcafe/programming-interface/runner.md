...
`speed`           | Number  | Specifies the speed of test execution. Controls the cursor speed and the delay between actions. Should be a number between `1` (fastest) and `0.01` (slowest). | `1`
