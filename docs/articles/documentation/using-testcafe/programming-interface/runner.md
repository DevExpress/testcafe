...
`disablePageReloads` | Boolean | Defines whether to disable page reloads between tests. See [Enabling and Disabling Page Reloads](../../test-api/test-code-structure.md#enabling-and-disabling-page-reloads).                                                                                                                  | `false`
