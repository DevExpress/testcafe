...
> Important! Front-end development tools (such as React DevTools, or Vue DevTools) can interfere with TestCafe and cause errors. Do not open them when you are running or debugging TestCafe tests.
