...
⚠️🛠️  This functionality is not 100% compatible with legacy tests generated by [TestCafe v2015.1](http://testcafe.devexpress.com/documentation). Use the `--disable-multiple-windows` CLI flag to disable multi-window testing capabilities.
