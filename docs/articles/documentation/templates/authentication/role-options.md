...
TestCafe navigates to the saved URL each time you switch to the role.

Use this option to prevent losing session-related data (like session ID) stored in the URL.
