...
> Important! To learn how to access child nodes, see [Accessing Child Nodes in the DOM Hierarchy](../examples-of-working-with-dom-elements.md#accessing-child-nodes-in-the-dom-hierarchy).
