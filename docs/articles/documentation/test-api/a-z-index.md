...
* [Selector](selecting-page-elements/selectors/creating-selectors.md)
    ...
    * [count](selecting-page-elements/selectors/functional-style-selectors.md#check-if-an-element-exists)
    * [exists](selecting-page-elements/selectors/functional-style-selectors.md#check-if-an-element-exists)
