...
> Vote for the following GitHub issue if you want us to support custom properties in the configuration file: [#3593](https://github.com/DevExpress/testcafe/issues/3593)
