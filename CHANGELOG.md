...
Earlier versions of TestCafe supported the [ESM Module](xref:404258) from the CLI only. In TestCafe v3.7.0 and higher, you can use the [esm](xref:402638#esm) configuration file option. Note that this option **only works** with Node.js 18.19-18.xx, and 20.8.0 and up.
...
* The [t.getCurrentCDPSession](xref:404913) method returns `unknown` ([#8228](https://github.com/DevExpress/testcafe/issues/8228)).
