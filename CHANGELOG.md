...
* `Function.prototype.toString` is now proxied correctly when it is overriden in a customer script ([testcafe-hammerhead#999](https://github.com/DevExpress/testcafe-hammerhead/issues/999))
