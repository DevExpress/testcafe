...
* TestCafe no longer fails if a client function argument contains ES6 method syntax ([#1279](https://github.com/DevExpress/testcafe/issues/1279))
* Errors that occur during browser provider initialization are now caught ([#1282](https://github.com/DevExpress/testcafe/issues/1282))
...
* Server no longer responses with status 222 when window.fetch() is called in Chrome ([#1134](https://github.com/DevExpress/testcafe/issues/1134))
