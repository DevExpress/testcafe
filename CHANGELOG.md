...
TestCafe now allows you to specify test run hooks. TestCafe executes these hooks before and after the entire test run ([PR #6487](https://github.com/DevExpress/testcafe/pull/6487)).
